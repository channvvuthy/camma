  ...
  <div class="bg-white h-screen py-2">
    ...
    >
      ...
      <div class="flex justify-start items-center mt-5">
        ...
        >
          <SaveIcon />
          <span class="pl-1">កែប្រែពាក្យសម្ងាត់</span
          ><span v-if="userChangingPassword" class="ml-2"
            ><Loader :size="10" /> ></span
          >
        </button>
      </div>
      <Message v-if="err" :message="errMessage" @closeMessage="closeMessage" />
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    changePassword() {
      ...
      this.userChangePassword(params)
        .then((response) => {
