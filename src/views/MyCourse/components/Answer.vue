      ...
      >
        ...
        >
          ...
          >
            ...
            <div class="cursor-pointer absolute w-8 h-8 bg-custom rounded-full flex items-center justify-center -right-5 -top-5" @click="closeAnswer">
          ...
          <div class="body bg-white">
                ...
                <ul>
                  ...
                  >
                    <div class="flex items-center">
                      <div
                        class="w-10 h-10 shadow rounded-full border border-custom bg-center bg-cover"
                        :style="{
            ...
            <div class="relative">
              ...
              <div class="flex px-5 mb-5">
                <div
                  class="w-10 h-10 shadow rounded-full bg-center border border-custom bg-cover​"
