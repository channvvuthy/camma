    ...
    <div id="video_player_box" class="flex-cols start items-center w-full relative">
        <template v-if="true">
            ...
            <div class="bg-black">
                <video id="my_video" class="m-auto w-full" ref="my_video"
                       ...
                       @click="playPause()"
                >
                    <source src="https://eschool-video.sabay.com/video/Diploma-English/EssentialBook3(Micha)/5f27c1c981768d50365d40d2-2_720.mp4"/>
                </video>
            </div>
        ...
        <template v-else>
            <div class="w-full flex-cols justify-center items-center">
                <video id="my_video" class="m-auto w-full bg-black"
                       :poster="!url.includes('file:///')?'/poster.png':''"
                       autoplay="autoplay"
                       controlsList="nodownload"
                       @timeupdate="timeUpdate()"
