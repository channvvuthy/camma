<template>
    <div class="bg-white h-screen py-5">
        <div class="px-5 font-khmer_os text-14px flex-cols justify-center items-center text-center w-96">
            <div class="bg-cover bg-center w-24 h-24 rounded-full bg-center flex justify-center items-center m-auto cursor-pointer border border-gray-200 mb-2 relative photo"
