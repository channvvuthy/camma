                  ...
                  >
                    <ul v-if="showSpeed">
                      ...
                      <li
                        ...
                        "
                        :class="
                          defaultSpeed < 1 ? 'text-red-500' : 'text-custom'
                        "
                      ...
                      <li
                        ...
                        "
                        :class="
                          defaultSpeed === 2 ? 'text-red-500' : 'text-custom'
                        "
...
import PauseIcon from "./../../MyCourse/components/media/PauseIcon";
import NextIcon from "./../../MyCourse/components/media/NextIcon";
import MutedIcon from "./../../MyCourse/components/media/MutedIcon";
import SoundIcon from "./../../MyCourse/components/media/SoundIcon";
import SettingIcon from "./../../MyCourse/components/media/SettingIcon";
import FullScreenIcon from "./../../MyCourse/components/media/FullScreenIcon";
